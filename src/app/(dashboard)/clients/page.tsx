...
import {
  ...
  Mail, Phone, Star, Users, TrendingUp, UserCheck, UserX,
...
const statCards = [
  ...
  { label: "Active", value: mockClients.filter(c => c.status === "active").length, icon: UserCheck, color: "text-emerald-600", bg: "bg-emerald-50" },
  { label: "VIP", value: mockClients.filter(c => c.status === "vip").length, icon: Star, color: "text-violet-600", bg: "bg-violet-50" },
  { label: "Total Revenue", value: formatCurrency(mockClients.reduce((s, c) => s + c.totalRevenue, 0)), icon: TrendingUp, color: "text-amber-600", bg: "bg-amber-50" },
];
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">{filtered.length} of {mockClients.length} clients</p>
        </div>
      ...
      <Card>
        ...
        <div className="flex items-center justify-between px-4 py-3 border-t border-slate-100">
          <p className="text-xs text-slate-500">Showing {filtered.length} of {mockClients.length} clients</p>
